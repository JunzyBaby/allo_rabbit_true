                        ...
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <?php if(config('settings.wildcard_domain_ready')): ?>
                                    <span class="blockquote-footer"><?php echo e((isset($_SERVER['HTTPS'])&&$_SERVER["HTTPS"] ?"https://":"http://").$restorant->subdomain.".".str_replace("www.","",$_SERVER['HTTP_HOST'])); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="col-4 text-right">
                                ...
                                <?php if(config('settings.wildcard_domain_ready')): ?>
                                    <a target="_blank" href="<?php echo e((isset($_SERVER['HTTPS'])&&$_SERVER["HTTPS"] ?"https://":"http://").$restorant->subdomain.".".str_replace("www.","",$_SERVER['HTTP_HOST'])); ?>" class="btn btn-sm btn-success"><?php echo e(__('View it')); ?></a>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/restorants/edit.blade.php ENDPATH**/ ?>
                               ...
                               <?php if(  !(isset($canDoOrdering)&&!$canDoOrdering)   ): ?>
                                <div class="quantity-area">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantity" id="quantity" class="form-control form-control-alternative" placeholder="<?php echo e(__('1')); ?>" value="1" required autofocus>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/restorants/partials/modals.blade.php ENDPATH**/ ?>
    ...
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                    <form role="form" method="GET" id="form-time-to-prepare" action="<?php echo e(route('update.status', ['accepted_by_restaurant',isset($order)?$order:""])); ?>">
...
<?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/orders/partials/modals.blade.php ENDPATH**/ ?>
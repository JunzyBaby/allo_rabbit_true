    ...
    <div id="liveorders" class="row">
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <!-- Title -->
              <h5 class="h3 mb-0"><?php echo e(__('New Orders')); ?></h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0"><?php echo e(__('Accepted')); ?></h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0"><?php echo e(__('Done')); ?></h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/orders/live.blade.php ENDPATH**/ ?>
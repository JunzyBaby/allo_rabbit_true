                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('systemstatus')); ?>" class="btn btn-sm btn-danger"><?php echo e(__('settings.system_status')); ?></a>
                            <?php if($newVersionAvailable): ?>
                                <a href="<?php echo e(route('settings.index')); ?>?do_update=true" class="btn btn-sm btn-success"><?php echo e(__('New version avaialbe')); ?> - v<?php echo e($newVersion); ?></a>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Settings')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/settings/index.blade.php ENDPATH**/ ?>
<div class="card card-profile shadow mt--300">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <?php if(!config('settings.is_whatsapp_ordering_mode') && !config('settings.whatsapp_ordering_enabled') && !config('settings.enable_facebook_ordering') && !config('settings.is_facebook_ordering_mode')): ?>
                        <!-- COD -->
  ...
  <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\foodtiger_original\resources\views/cart/payment.blade.php ENDPATH**/ ?>